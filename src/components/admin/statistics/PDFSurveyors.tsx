            ...
            <Box key={chapter.id} mt={2}>
              ...
              {chapter.questions.map((question, index) => (
                <Box m={1} mb={1} key={question.id}>
                  {chapter.questions[index].type ===
                    TypeQuestion.GEOLOCATION && (
                                ...
                                <Grid item xs={12}>
                                  {answer && (
                                   /*  <AsyncImage  src={answer.respuesta.value}  className={classes.media}/> */
                                    <img loading="lazy" src={answer.respuesta.value} alt="ImageAnswer" className={classes.media} />
                                    /*  <Card
