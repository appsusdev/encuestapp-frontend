...
import { setActiveEntity } from '../../redux/actions/entitiesActions'
import { uiOpenModalDelete, uiOpenModalEdit } from '../../redux/actions/uiActions'
import { IEntities } from '../../redux/types/types'
    ...
    return (
        ...
        <TableRow key={entity.nit}>
                ...
                <TableCell style={{ width: 130 }} align="center">
                    <CustomizedIcons editIcon deleteIcon  onEdit={onEdit} onDelete={onDelete} />
                </TableCell>
            </TableRow>
