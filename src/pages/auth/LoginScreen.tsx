...
export const LoginScreen: FC<{}> = () => {
    ...
    const { errorAlert } = useSelector<AppState, AppState['ui']>(state => state.ui);
    ...
    return (
        <Box className={classes.appAuth}>
            ...
            <MyAlert open={errorAlert} typeAlert="error" message="IncorrectEmailPassword" time={4000} handleClose={handleClose}/>
        </Box>
    )
}
